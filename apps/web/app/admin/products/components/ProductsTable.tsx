                  ...
                  <tr key={product.id} className="hover:bg-[#dcc090]/10">
                    ...
                    <td className="px-3 py-4 whitespace-nowrap text-center">
                      <div className="inline-flex items-center justify-center gap-1">
                        ...
                        <button
                          onClick={() => handleToggleUpcoming(product.id, product.upcoming || false, product.title)}
                          className="inline-flex items-center justify-center w-8 h-8 transition-all duration-200 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 rounded"
                          title={product.upcoming ? t('admin.products.clickToRemoveUpcoming') : t('admin.products.clickToMarkUpcoming')}
                        >
                          <svg
                            className={`w-5 h-5 transition-all duration-200 ${
                              product.upcoming
                                ? 'fill-amber-500 text-amber-500 drop-shadow-sm'
                                : 'fill-none stroke-amber-400 text-amber-400 opacity-50 hover:opacity-75'
                            }`}
                            viewBox="0 0 24 24"
                            strokeWidth="1.5"
                            stroke="currentColor"
